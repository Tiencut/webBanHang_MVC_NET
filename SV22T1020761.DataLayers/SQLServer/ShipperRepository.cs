...
namespace SV22T1020761.DataLayers.SQLServer
{
    ...
    public class ShipperRepository : SV22T1020761.DataLayers.Interfaces.IGenericRepository<Shipper>
    {
        ...
        /// <summary>
        /// List shippers with paging and optional search.
        /// </summary>
        public async Task<PagedResult<Shipper>> ListAsync(PaginationSearchInput input)
        {
            input ??= new PaginationSearchInput();
            var result = new PagedResult<Shipper> { Page = input.Page, PageSize = input.PageSize };
...
OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY";
        ...
        /// <summary>
        /// Add a new shipper and return generated id.
        /// </summary>
